...
AskGC
 ...
 Description: Each field is compared with fields in the database. If there are no issues then the password field in the database is updated to reflect the users newly desired password.
*/
<?php
