...
<html>
  ...
  <body>
    <div class="form">
      ...
      <ul class="tab-group">
        <li class="tab"><a onclick="location.href='login.php'">Log In</a></li>
        <li class="tab active"><a onclick="location.href='signup.php'">Sign Up</a></li>
      </ul>
